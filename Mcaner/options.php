...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'type' => 'editor',
		'settings' => $wp_editor_settings );
		//YENİ SEKME OLUŞTULUYOR !!!!!!!!
	$options[] = array(
		'name' => __('Ayarlar', 'options_check'),
		'type' => 'heading');
		
	$options[] = array(
		'name' => __('Site Title', 'options_check'),
		'desc' => __('Site title buraya giriniz.', 'options_check'),
		'id' => 'site_basligi',
		'std' => 'Site ismim mcaner',
		'class' => 'mini',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Site Açıklaması', 'options_check'),
		'desc' => __('Site açıklamasını buraya giriniz.', 'options_check'),
		'id' => 'site_aciklamasi',
		'std' => 'Site ismim mcaner',
		'type' => 'textarea');
		
	$options[] = array(
		'name' => __('Site Logosu', 'options_check'),
		'desc' => __('Sitenin logosunu seçebilirsiniz.', 'options_check'),
		'id' => 'site_logo',
		'type' => 'upload');
		
		//EDİTÖR BAŞLANGIÇ
	$options[] = array(
		'name' => __('Editörler', 'options_check'),
		'type' => 'heading');
	...
	$options[] = array(
		'name' => __('Benim Editörüm', 'options_check'),
		'desc' => sprintf( __( 'Açıklama Bölümü ', 'options_check' ), 'http://codex.wordpress.org/Function_Reference/wp_editor' ),
		'id' => 'editör_1',
		'type' => 'editor',
		'settings' => $wp_editor_settings );
		
		//Multi Seçme Özelliği
		
	$options[] = array(
		'name' => __('MultıCheck', 'options_check'),
		'type' => 'heading');
		
	$options[] = array(
		'name' => __('Kategoriler', 'options_check'),
		'desc' => __('Multicheck description.', 'options_check'),
		'id' => 'site_kategori',
		'std' => $options_categories, // These items get checked by default
		'type' => 'multicheck',
		'options' => $options_categories );
	...
	$options[] = array(
		'name' => __('Select', 'options_check'),
		'type' => 'heading');
	$options[] = array(
		'name' => __('Select 1', 'options_check'),
		'desc' => __('Multicheck description.', 'options_check'),
		'id' => 'select_1',
		'std' => $options_categories, // These items get checked by default
		'type' => 'select',
		...
		// kullanma şekli -----
		/* 
			<?php $secilen=of_geT_option("select_1"); ?>
